...
ws.onmessage = function(message) {
    ...
    switch (msg["type"]) {
        ...
        case "model_params":
            ...
            var start_tick = msg["start_tick"];
            console.log("start_tick")
            console.log(msg["start_tick"])
            reset(start_tick);
            initGUI();
            break;
        default:
...
var reset = function(start_tick) {
    control.tick = start_tick;
    send({"type": "reset"});
...
var single_step = function() {
    var checked = true;
    var checkbox = document.getElementById("CO2Cost");
    checkbox.onclick = function() {
    var checked = false;
    console.log('button clicked');
    }
    console.log("CO2Cost checked!");
    console.log(checked);
    control.tick += 1;
    send({"type": "get_step", "step": control.tick, "co2check": checked});
};
