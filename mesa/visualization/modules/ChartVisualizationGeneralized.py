...
class ChartModule2(VisualizationElement):
    ...
    package_includes = ["Chart.min.js", "ChartModule2.js"]
    ...
    def __init__(
        ...
        self.type = series[0]["Type"]
        series_json = json.dumps(self.series)
        new_element = "new ChartModule2({}, {},  {}, {})"
        #new_element = new_chart_command
    ...
    def render(self, model):
        ...
        for s in self.series:
            ...
            current_values = val#data_collector.model_vars[name][-1]
